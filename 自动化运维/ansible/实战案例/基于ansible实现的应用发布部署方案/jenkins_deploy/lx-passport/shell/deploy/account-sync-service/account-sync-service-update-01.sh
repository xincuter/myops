...
APP_GROUP="prd-lx-passport_account-sync-part01"
...
UPSTREAM_FILE="${NGINX_CONF_DIR}/upstream_account-sync.conf-part01"
...
UPDATE_LOG_DIR="/jenkins_deploy/lx-passport/logs/update/$PROJ_NAME/part01"
...
##nginx下线第1批account-sync-service服务,上线第2批account-sync-service服务
NGINX_OFFLINE() {
