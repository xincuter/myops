...
##define variables
PROJ_NAME="dubbo-encoder"
APP_GROUP="prd-lx-passport_dubbo-encoder-part02"
ANSIBLE_CMD="/usr/bin/ansible"
UPDATE_SCRIPT="/usr/local/weihu/lx-passport-update_dubbo-encoder.sh"
LOCAL_PKG_DIR="/jenkins_deploy/lx-passport/sftp/${DATE}/${PROJ_NAME}"
DST_TMP_DIR="/data/update/pkg/dubbo_tmp"
UPDATE_LOG_DIR="/jenkins_deploy/lx-passport/logs/update/dubbo/${PROJ_NAME}/part02"
