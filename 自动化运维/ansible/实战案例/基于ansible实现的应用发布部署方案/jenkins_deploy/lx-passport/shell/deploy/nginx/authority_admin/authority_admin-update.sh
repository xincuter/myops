...
##define variables
PROJ_NAME="authority_admin"
ANSIBLE_CMD="/usr/bin/ansible" 
APP_GROUP="prd-lx-passport_nginx"
UPDATE_SCRIPT="/usr/local/weihu/lx-passport-update_nginx-${PROJ_NAME}.sh"
LOCAL_PKG_DIR="/jenkins_deploy/lx-passport/sftp/${DATE}/${PROJ_NAME}"
DST_TMP_DIR="/data/update/pkg/nginx_admin_tmp"
UPDATE_LOG_DIR="/jenkins_deploy/lx-passport/logs/update/nginx/$PROJ_NAME"
