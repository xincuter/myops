#!/bin/bash
#description: ansible实现批量部署应用环境(仅适用于centos6)...
#version: v1.2
#auth: by zhengxin20180720
#email: hzzxin@tairanchina.com

DATE="$(date +%Y%m%d_%H%M)"
DYN_INVENTORY="/ansible-deploy/inventory/centos6_ip_list"
PLAYBOOK_DIR="/ansible-deploy/playbook/centos6"
...
APP_DIR="/usr/local/weihu/software/centos6"
LOG_DIR="/ansible-deploy/logs/centos6"
APP_LIST=(env_init.tar.gz rabbitmq.tar.gz trc-apr-1.5.2-1.el6.x86_64.rpm trc-apr-iconv-1.2.1-1.el6.x86_64.rpm trc-apr-util-1.5.4-1.el6.x86_64.rpm trc-jdk-1.8.0_77-1.el6.x86_64.rpm trc-nginx-1.12.2-3.el6.x86_64.rpm trc-node-v6.11.2-1.el6.x86_64.rpm trc-node-v8.10.0-1.el6.x86_64.rpm trc-tomcat-8.0.32-1.el6.x86_64.rpm trc-tomcat-native-1.1.34-1.el6.x86_64.rpm trc-zookeeper-3.4.6-1.el6.x86_64.rpm)
